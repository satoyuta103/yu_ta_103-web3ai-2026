...
| 項目 | 回答 |
|---|---|
| デプロイURL(Vercel等) | [StainShield](https://satoyuta103.github.io/yu_ta_103-web3ai-2026/stain-shield/) |
| 一言紹介 | 白い服を着た日のシミリスクを診断し、超撥水Tシャツの防護効果をWeb上で疑似体験できるデモアプリ |
